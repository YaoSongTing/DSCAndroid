...
<div class='footer'>
    <ul>
        <router-link to="/home" tag="li">
            <div class="nav-img">
                <i class="iconfont icon-shouye" v-if="this.$route.path.includes('/home')"></i>
        ...
        <router-link to="/category/858" tag="li">
            <div class="nav-img">
                <i :class="['iconfont','icon-leimupinleifenleileibie2',{'router-link-active':this.$route.path.includes('/category')}]" v-if="this.$route.path.includes('/category')"></i>
        ...
        <router-link to="/search" tag="li">
            <div class="nav-img">
                <i class="iconfont icon-faxian" v-if="active=='search'"></i>
        ...
        <router-link to="/cart" tag="li">
            <div class="nav-img">
                ...
                <i class="iconfont icon-ai66 " v-else ></i>
            </div>
            <span>购物车</span>
        </router-link>
